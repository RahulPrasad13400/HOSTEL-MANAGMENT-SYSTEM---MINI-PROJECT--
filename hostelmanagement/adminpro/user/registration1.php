...
$dao=new DataAccess();
$elements=array(
        "fname"=>"","lname"=>"","email"=>"","phno"=>"","password"=>"","cpassword"=>"");


$form=new FormAssist($elements,$_POST);
//$file=new FileUpload();
$labels=array('fname'=>"First Name","lname"=>"Last Name","email"=>"Email Id","phno"=>"Phone Number","password"=>"Password","cpassword"=>"Confirm Password");

$rules=array(
    "fname"=>array("required"=>true,"minlength"=>3,"maxlength"=>10,"alphaspaceonly"=>true),
    "lname"=>array("required"=>true,"minlength"=>3,"maxlength"=>10,"alphaonly"=>true),
    "email"=>array("required"=>true,"email"=>true,"unique"=>array("field"=>"email","table"=>"registration")),
    
    "phno"=>array("required"=>true,"integeronly"=>true,"minlength"=>10,"maxlength"=>10),
                ...
                <div class="card-body">
					...
					<p><?php if(isset($msg)) echo $msg; ?></p>
                        <div class="input-group">
                         ...
                         <div class="input-group">
                             <?= $form->textBox('phno',array("placeholder"=>"Phone Number")); ?>
                           <span class="valErr"><?= $validator->error('phno'); ?></span>
