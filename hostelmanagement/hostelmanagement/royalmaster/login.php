...
$elements=array("uemail"=>"","upassword"=>"");
$form=new FormAssist($elements,$_POST);
$rules=array(
    'uemail'=>array('required'=>true),
...
if(isset($_POST['login']))
{
    ...
    {
        $data=array('uemail'=>$_POST['uemail'],'upassword'=>$_POST['upassword']);
        if($info=$dao->login($data,'registration'))
        {
           
            $_SESSION['uemail']=$info['uemail'];
$a=$_SESSION['uemail'];
			...
			<div class="wrap-login100">
				<form method="POST" class="login100-form validate-form">
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type user name">
						<input id="first-name" class="input100" type="text" name="uemail" placeholder="User name">
