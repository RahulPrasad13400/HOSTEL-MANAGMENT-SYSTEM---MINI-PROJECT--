      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="roomimage.php">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Room Image</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="viewtype.php">
                <i class="menu-icon typcn typcn-th-large-outline"></i>
                <span class="menu-title">View Type</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="viewroomimage.php">
                <i class="menu-icon typcn typcn-bell"></i>
                <span class="menu-title">View Room Image</span>
              </a>
            </li>
            <li class="nav-item">
